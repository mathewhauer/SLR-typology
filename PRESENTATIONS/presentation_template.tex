...
% \titlegraphic{\includegraphics[width=0.3\paperwidth]{georgialogo.png}} % <-- if you want to know what this looks like without it as a Markdown field.
% -----------------------------------------------------------------------------------------------------
$if(titlegraphic1)$\titlegraphic{
\begin{tikzpicture}[overlay, remember picture]
\node[at=(current page.south), anchor=south] {
\includegraphics[width=0.2\paperwidth, height=0.2\paperheight]{$titlegraphic1$} \includegraphics[width=0.2\paperwidth, height=0.2\paperheight]{$titlegraphic2$}
};
\end{tikzpicture}
}$endif$
...
% \definecolor{clemsonorange}{HTML}{EA6A20}
 \definecolor{clemsonorange}{HTML}{BA0C2F}
